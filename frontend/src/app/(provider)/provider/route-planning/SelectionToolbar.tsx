...
export default function SelectionToolbar({
  ...
  return (
    <div
      className="fixed bottom-0 inset-x-0 z-[500] flex justify-center pointer-events-none pb-[max(0.75rem,env(safe-area-inset-bottom,0px))] px-3"
    ...
    >
      ...
      >
        <div className="flex items-center gap-2 min-w-0">
          ...
          <button
            type="button"
            className="text-xs text-[#5C6570] underline underline-offset-2 shrink-0 min-h-11 px-2"
            onClick={onClear}
        ...
        <div className="w-full min-w-0">
          <SearchableSelect
            ...
            inputClassName="h-11 px-3 rounded-xl bg-white border border-[#E5E9EF] text-sm w-full min-w-0"
          />
        </div>
        ...
        <div className="grid grid-cols-2 gap-2 sm:grid-cols-[1fr_1fr_auto]">
          <button
            type="button"
            className="h-11 px-3 rounded-xl border border-[#E5E9EF] text-xs font-medium text-[#0B1220] hover:bg-[#F4F6F8] disabled:opacity-50 inline-flex items-center justify-center gap-1 col-span-2 sm:col-span-1"
            onClick={onOpenRange}
          ...
          <button
            type="button"
            className="h-11 px-3 rounded-xl border border-[#E5E9EF] text-xs font-medium text-[#0B1220] hover:bg-[#F4F6F8] disabled:opacity-50"
          ...
          <button
            type="button"
            className="h-11 px-4 rounded-xl bg-[#00BFA5] text-white text-xs font-semibold hover:bg-[#00a892] disabled:opacity-50 sm:min-w-[5.5rem]"
            onClick={onAssign}
            disabled={busy}
