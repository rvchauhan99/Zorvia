...
export default function ProviderSignup() {
  ...
  async function onSubmit(e) {
    ...
    setSubmitting(true);
    try {
      const payload = { ...form, meal_price_default: Number(form.meal_price_default), cutoff_hours: Number(form.cutoff_hours) };
      const s = await providerSignup(payload);
      toast.success(`Workspace created. Welcome, ${s.display_name}!`);
      ...
      <div className="max-w-5xl mx-auto p-6 sm:p-10">
        ...
        <div className="mt-6 grid grid-cols-1 lg:grid-cols-5 gap-8">
          <div className="lg:col-span-2 flex flex-col gap-4">
            ...
            <div className="card-tinted p-4 text-sm">
              <div className="label-overline">What you get</div>
              <ul className="mt-2 space-y-1 text-foreground/80 list-disc pl-4">
          ...
          <form onSubmit={onSubmit} className="lg:col-span-3 card-tinted p-6 lg:p-8 flex flex-col gap-5">
            ...
            <button data-testid="signup-submit" disabled={submitting} className="pill-btn btn-primary h-12 gap-2 disabled:opacity-60">
            ...
            <GoogleSignInButton
              ...
              label={form.org_name ? "Continue with Google" : "Enter a workspace name to use Google"}
